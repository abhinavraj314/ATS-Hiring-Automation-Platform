...
const SettingsPage: React.FC = () => {
  ...
  const handleExportData = async (format: "csv" | "json" = "csv") => {
    try {
      setExporting(true);
      await candidateService.exportAllCandidates(format);
  ...
  const handleDeleteAccount = () => {
    if (
      confirm(
        "Are you absolutely sure? This will permanently delete all your recruiter data.",
      )
    ) {
      ...
      <div className="p-8 max-w-5xl mx-auto space-y-10 pb-20 relative">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Configure your profile and security preferences
          </p>
        </div>
        ...
        <section className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="md:col-span-2 border-slate-200 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                This information will be displayed on candidate communications.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue="Enterprise Hiring"
                  className="border-slate-300"
                />
              </div>
            </CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-slate-500">
                      Download all candidate information including names,
                      skills, status, scores, and interview progress.
                    </p>
                  </div>
